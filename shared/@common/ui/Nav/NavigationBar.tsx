...
export const NavigationBar = () => {
  ...
  return (
    <div className="w-full flex bg-white justify-center items-center">
       <div className="w-[978px] py-[15px] mobile:px-[15px] px-4 flex flex-row bg-white justify-between items-center sticky gap-10 z-10 tablet:w-[678px] tablet:gap-2 mobile:grid mobile:grid-cols-3 mobile:gap-[1px]">
